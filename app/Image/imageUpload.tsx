...
export default function ImageUpload({image, setImage} : {image:File|null, setImage: Function}) {
  ...
  return (
    <>
      <div className="relative w-10/12 h-70svh md:w-9/12 xl:w-6/12 mt-8">
        <div className="flex flex-col justify-center place-items-center text-xl absolute top-0 left-0 w-full h-70svh border-2 border-black" style={{backgroundColor:'#516685'}}>
        ...
        <input
          type="file"
          onChange={uploadFile}
          className="opacity-0 absolute top-0 left-0 w-full h-70svh"
