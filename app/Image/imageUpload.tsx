...
export default function ImageUpload({image, setImage} : {image:File|null, setImage: Function}) {
  ...
  return (
    <>
      <div className="relative pt-8 w-10/12 h-70svh md:w-9/12 xl:w-6/12">
        <div className="bg-zinc-300 flex flex-col justify-center place-items-center text-xl absolute top-0 left-0 w-full h-70svh"  >
